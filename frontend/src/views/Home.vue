...
<script>
/**
 * This is a Smart Component which acts as container for all pokemons,
...
export default {
  ...
  computed: {
    ...
    /**
     * Gets complete pokemons list and filter based on searched text and selected types
     * it has 3 steps
  ...
  methods: {
    ...
    /**
     * Helper function to filter pokemons list by names
     */
